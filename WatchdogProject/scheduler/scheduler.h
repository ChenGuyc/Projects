/* 
*  scheduler is a tool used for creating scheduled tasks, recurring or
*   non-recurring.
*
...
* -   SchDestroy - Destroys given scheduler
...
* -   Timer Cancel - Cancels an existing timer in the scheduler 
*
*  
*
Scheduler API
...
*                                 -2- Stop function rename.
*                                 -3- adding more description to SchTimerStart.
*                                                         
*/
...
int taskFunction1(sch_t *sch, unique_id_t uid, void *param)
{
    if ((size_t)param == 1)
    {
...
int main()
{
    schTimerStart(sch, 3, taskFunction1, 1);
    schTimerStart(sch, 4, taskFunction1, 2);
}
...
*
* Return Value:
*   - if succeeded, returns a pointer to a scheduler.
